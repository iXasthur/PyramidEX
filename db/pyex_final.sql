...
--
-- Хост: 127.0.0.1
-- Время создания: Май 09 2020 г., 01:18
...
INSERT INTO `user` (`id`, `nickname`, `email`, `password_hash`, `seller_fee`, `buyer_fee`, `kyc_status`) VALUES
(7, 'admin', 'admin@pyex.com', '$argon2i$v=19$m=65536,t=4,p=1$VUNLc1F2WmcydHNXMDJDOA$82rzevbTx0Uif6XU5vSE2yjeAb55U/1BwSxUdVSN6+E', 0, 0, 1);
